      ...
      <el-table-column label="操作" fixed="right" align="center">
        <template scope="scope">
          <el-button size="small"
                     @click="openDialog(scope.$index,scope.row)">查看或修改
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="查看或修改商户信息" :visible.sync="dialogFormVisible">
      <el-form ref="form" :model="newRow.user" :rules="addRules" label-width="13%">
        ...
        <el-form-item label="点位设置">
          <el-button type="primary" @click="alipayRateDialogFormVisible = true">查看或修改点位</el-button>
        </el-form-item>
...
<script>
  import {merchantsMy, updateMerchant,getSelect, getPayType, getPayRateList, updatePayRateList} from '@/api/role'
