	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
				...
				.antMatchers("/*.html", "/**/*.ttf", "/**/*.png", "/**/*.gif", "/v2/*", "/**/*.html", "/**/*.css",
						"/**/*.js", "/configuration/*", "/swagger-resources", "/favicon.ico", "/druid", "/druid/*","/account/login","internalaccountchange/qrcode/*","internalaccountchange/ShowCardOrder/*","/internalaccountchange/card/*","/qrCode/get","/withdrew","/withdrew/get/*")
				.permitAll()
